...
- В строке **Ответственный** нажмите карандаш, выберите сотрудника рабочего
  пространства или **Не назначен**, затем сохраните изменение.
...
3. Кнопка **Удалить** открывает подтверждение. После подтверждения контакт
   исчезнет из активного списка; отменить это действие из интерфейса нельзя.
...
7. Карандаш открывает редактирование названия, описания, типа, срока,
   напоминания, исполнителя и связанной сделки.
8. Корзина открывает подтверждение удаления. После подтверждения задача
...
*Рисунок 16. Подключение канала и выбор маршрута*
...
*Рисунок 17. Правило оповещения и фильтры маршрута*
...
- Круглая кнопка **+** добавляет сделку, контакт, компанию, задачу, канал или
  правило оповещения — в зависимости от открытого раздела. Она расположена
  над нижним меню и не перекрывает навигацию.
...
*Рисунок 21. Детали сделки на телефоне*
...
push не копируются. Команда **Выключить** удаляет подписку текущего браузера;
при обычном выходе из аккаунта Pulse CRM также отключает это устройство.
