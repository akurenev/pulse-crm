...
- Используйте поиск по имени, тегу, телефону или Email. Для компаний поиск
  дополнительно учитывает сайт и значения пользовательских полей. Результаты
...
![Карточка компании со связанным контактом и кнопкой редактирования](user-guide/screenshots/08-company-card.jpg)

*Рисунок 10а. Карточка компании со связанными контактами*

1. Переключитесь на **Компании** и нажмите строку организации.
2. Нажмите **Редактировать**, чтобы изменить название, основной Email, телефон,
   сайт или теги. После сохранения карточка и список обновятся.
