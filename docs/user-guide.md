...
поля **ИНН** либо из реквизита ИНН поля **Юр. лицо**. Теги контактов, компаний
и сделок переносятся вместе с соответствующей записью. Воронки переносятся
вместе с этапами; одинаковые системные этапы в разных воронках обрабатываются
раздельно.
...
> перенесённых компаний и теги у ранее перенесённых сделок. Значения обновляются
> из amoCRM, а сами записи не дублируются.
