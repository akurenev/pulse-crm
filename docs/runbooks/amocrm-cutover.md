...
2. Запустить `POST /api/v1/admin/integrations/imports/start` с
   ...
   заметки. ИНН компаний, а также теги компаний, контактов и сделок входят в
...
6. Сверить количества по типам, воронкам и этапам, суммы сделок, открытые
   задачи, ИНН компаний, теги и обычные примечания сделок; вручную проверить 100
   случайных записей каждого критичного типа.
...
5. Сверить counts, этапы, ответственных, задачи, ИНН компаний и контрольную
   выборку.
