...
export default function ContactsPage() {
  ...
  const sourceContacts = useMemo<Contact[]>(() => {
    ...
    return (remoteContacts.data?.items ?? []).map((contact) => ({
      id: contact.id,
      ...
      >
        <Dialog.Portal>
          ...
          <Dialog.Content className="dialog-content record-dialog">
            ...
            {selectedContact ? <div className="record-detail-grid">
            ...
            {selectedCompany ? <div className="record-detail-grid">
            ...
            {selectedContact ? <section className="record-purchases">
