...
const demoChannels: ApiChannelConnection[] = [
  { id: "demo-email", kind: "email", name: "Общая почта", status: "active", settings: { address: "sales@example.com" }, default_pipeline_id: "pipeline-repeat-sales", default_stage_id: "new", default_assignee_id: null, has_credentials: true, last_healthcheck_at: DEMO_NOW, last_error: null, version: 1, created_at: DEMO_NOW, updated_at: DEMO_NOW },
...
const demoForms: ApiHtmlForm[] = [
  { id: "demo-form", slug: "request-offer", title: "Запрос предложения", pipeline_id: "pipeline-repeat-sales", stage_id: "new", assignee_id: null, source_id: null, fields_schema: [], allowed_origins: ["https://example.com"], honeypot_field: "company_website", success_message: "Спасибо! Мы свяжемся с вами.", is_active: true, version: 1, created_at: DEMO_NOW, updated_at: DEMO_NOW },
];
